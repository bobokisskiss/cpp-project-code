...
void test_eigen() {
    ...
    for (int n : dimensions) {
        ...
        std::cout << "Eigen, n=" << n << ", average time per determinant: " << (total_time / repetitions) << " seconds" << std::endl;
    }
}
...
void test_armadillo() {
    ...
    for (int n : dimensions) {
        ...
        std::cout << "Armadillo, n=" << n << ", average time per determinant: " << (total_time / repetitions) << " seconds" << std::endl;
    }
}
...
void test_xtensor() {
    ...
    for (int n : dimensions) {
        ...
        for (int i = 0; i < repetitions; ++i) {
            auto start = std::chrono::high_resolution_clock::now();
            double det = xt::linalg::det(xtensor_matrix);
            auto end = std::chrono::high_resolution_clock::now();
        ...
        std::cout << "XTensor, n=" << n << ", average time per determinant: " << (total_time / repetitions) << " seconds" << std::endl;
    }
}
